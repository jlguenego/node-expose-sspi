[node-expose-sspi](../README.md) › ["src/sso/connect"](_src_sso_connect_.md)
...
*Defined in [src/sso/connect.ts:22](https://github.com/jlguenego/node-expose-sspi/blob/e5fb53c/src/sso/connect.ts#L22)*
