[node-expose-sspi](../README.md) › ["src/sso/auth"](_src_sso_auth_.md)
...
*Defined in [src/sso/auth.ts:21](https://github.com/jlguenego/node-expose-sspi/blob/e5fb53c/src/sso/auth.ts#L21)*
